...
Using a generative DAG, @fig-lineDag presents the Bayesian version of simple linear regression.
...
#| results: hide
#| label: fig-lineDag
#| fig-cap: Generative DAG model using Bayesian linear regression.
#| out-width: 95%
pgm.show()
```
