...
# Plot 1: Tree structure with node information
plot_tree(tree_model, feature_names=['Time', 'StressSurvey'], 
          filled=True, rounded=True, fontsize=10, ax=ax1)
ax1.set_title('Decision Tree with Node Information', fontsize=14, weight='bold')
...
bars1 = ax2.bar(x - width/2, manual_importance, width, label='Manual Calculation', 
                color='lightblue', alpha=0.8, edgecolor='black')
bars2 = ax2.bar(x + width/2, sklearn_importance, width, label='Sklearn Calculation', 
                color='lightcoral', alpha=0.8, edgecolor='black')

ax2.set_xlabel('Features', fontsize=12)
ax2.set_ylabel('Feature Importance', fontsize=12)
ax2.set_title('Feature Importance: Manual vs Sklearn', fontsize=14, weight='bold')
ax2.set_xticks(x)
