...
**This is an investigative report, not a coding exercise.** You're analyzing two investment strategies and reporting your findings like a professional analyst would. Think of this as a brief you'd write for a client or manager.

**What makes a great report:**
- **Clear narrative:** Tell the story of what you discovered
- **Insightful analysis:** Focus on the most interesting differences between strategies
- **Professional presentation:** Clean, readable, and engaging
- **Concise conclusions:** No AI babble or unnecessary technical jargon
- **Human insights:** Your interpretation of what the numbers actually mean

**What we're looking for:** A report that someone could read in 5-10 minutes and understand both strategies, their risks, and which one might be better for different types of investors.
:::
...
6. **Strategy Comparison:** Run 100 simulations for the modified game strategy shown below in @exm-ErgodicityEconomicsExampleModified. What is the probability that your account balance will be greater than your original account balance of $1,000 at age 55? Is this probability higher or lower than the probability in the original game?

::: {.callout-tip}
## 🎯 For 100% Grade: Focus on What's Most Interesting

**The key insight:** These two strategies have dramatically different risk profiles, and that's what makes this analysis fascinating. Don't just report numbers—explain what they mean.

**What to investigate:**
- **Risk vs. Reward:** Which strategy offers better upside potential? Which is safer?
- **The "Ergodicity Problem":** Why does the math say one thing but reality shows another?
- **Practical implications:** If you were advising a 25-year-old, which strategy would you recommend and why?
- **The counter-intuitive result:** The strategy that seems "safer" (betting only 50%) might actually be riskier in the long run

**Write like a financial analyst:** Your report should help someone understand not just what happened, but why it happened and what it means for real-world decision making.
:::
...
- [ ] Focus on the most interesting findings, not just technical details
- [ ] Professional writing style (no AI-generated fluff)
- [ ] Concise analysis that gets to the point
- [ ] Practical insights that would help a real investor
...
- **Think Like an Analyst:** Document your findings as if you're writing a brief for a client, not just completing homework
- **Focus on Insights:** The most interesting part is how these strategies differ in their risk profiles—that's your story
- **Keep It Concise:** Professional reports are brief and to the point. Avoid unnecessary technical jargon
